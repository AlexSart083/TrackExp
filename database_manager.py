"""
Database Manager per integrazione con Supabase PostgreSQL
"""
        ...
        try:
            ...
            for spesa in spese_giornaliere:
                cursor.execute(
                    ...
                    (username, spesa['data'], spesa['categoria'], spesa['descrizione'], spesa['importo'], spesa.get('conto'))
                )
            ...
            for spesa in spese_ricorrenti:
                cursor.execute(
                    ...
                    (username, spesa['nome'], spesa['categoria'], spesa['importo'], spesa['frequenza'], spesa.get('conto'))
                )
